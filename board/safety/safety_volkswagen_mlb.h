...
static void volkswagen_mlb_rx_hook(CANPacket_t *to_push) {
...
static bool volkswagen_mlb_tx_hook(CANPacket_t *to_send) {
...
const safety_hooks volkswagen_mlb_hooks = {
  ...
  .compute_checksum = volkswagen_mlb_mqb_compute_checksum,
};